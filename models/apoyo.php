...
class apoyo extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'menajes' => 'Menajes',
            'aport_alimentacion' => 'Aport Alimentacion',
            'materiales_const' => 'Materiales Const',
            'sacos' => 'Sacos',
            'otros' => 'Otros',
            'trasnf_economicas' => 'Trasnf Economicas',
            'recurs_ejecutados' => 'Recurs Ejecutados',
            'fecha_entrega' => 'Fecha Entrega',
            'objeto_fngr' => 'Objeto Fngr',
            'apoyo_fngr_recuperacion' => 'Apoyo Fngr Recuperacion',
            'aport_munucipio' => 'Aport Munucipio',
            'aport_bomberos' => 'Aport Bomberos',
            'aport_epc' => 'Aport Epc',
            'aport_fuerz_armadas' => 'Aport Fuerz Armadas',
            'aport_defen_civil' => 'Aport Defen Civil',
            'aport_car' => 'Aport Car',
            'aport_otras' => 'Aport Otras',
            'don_nacionanles' => 'Don Nacionanles',
            'don_internacional' => 'Don Internacional',
            'don_otras' => 'Don Otras',
        ];
    }
