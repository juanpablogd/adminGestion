...
class afectacion extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            'id' => 'ID',
            'id_app_descripcion' => 'Cod. Descripción',
            ...
            'no_vias' => 'No. Vías',
            'no_ptes_vehi' => 'No. Puentes Vehiculares',
            'no_ptes_peato' => 'No. Puentes Peatonales',
            'no_acueductos' => 'No. Acueductos',
            'no_alcantarillados' => 'No. Alcantarillados',
            'no_plan_tratamiento_potable' => 'No. Plan Tratamiento Potable',
            'no_plan_tratamiento_residu' => 'No. Plan Tratamiento Residuales',
            'no_c_salud' => 'No. Centros Salud',
            'no_c_educativos' => 'No. Centros Educativos',
            'no_c_comunitarios' => 'No. Centros Comunitarios',
            'no_e_panelera' => 'No. E. Panelera',
            'no_bosq_natural' => 'No. Bosque Natural',
            'no_bosq_inter' => 'No. Bosque Intervenido',
            'no_bos_plantado' => 'No. Bosque Plantado',
            'no_bos_seco' => 'No. Bosque Seco',
            'no_paramo' => 'No. Paramo',
            'no_sabana' => 'No. Sabana',
            'no_pastos' => 'No. Pastos',
            'no_rastrojo' => 'No. Rastrojo',
            'no_vegetacion' => 'No. Vegetación',
            'no_seca' => 'No. Seca',
            ...
            'no_aves' => 'No. Aves',
            'no_peces' => 'No. Peces',
            'id_app_cul_transitorio' => 'Cul. Transitorio',
            'no_cul_transitorio' => 'No. Cultivos Transitorio',
            'id_app_cul_permanente' => 'Cul. Permanente',
            'no_cul_permanente' => 'No. Cultivos Permanente',
            'id_app_cul_hortalizas' => 'Cul. Hortalizas',
            'no_cul_hortalizas' => 'No. Cultivos Hortalizas',
            'id_app_cul_otras_hortalizas' => 'Cul. Otras Hortalizas',
            'no_cul_otras_hortalizas' => 'No. Cultivos Otras Hortalizas',
            'id_app_cul_frutales' => 'Cul. Frutales',
            'no_cul_frutales' => 'No. Cultivos Frutales',
            'no_frutales_disper' => 'No. Frutales Dispersos',
        ];
    }
